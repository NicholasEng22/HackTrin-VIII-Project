...
private int zipcode;
private double dFromWork;

/* Constructor */

public House(boolean a,double b, String h, boolean i, boolean j, int k, double l){
  this.isAvailable = a;
  this.description = h;
  this.hasElevator = i;
  this.hasRamp = j;
...
public int getScore(){
  ...
  if(this.getRent() <= 1000){
    score++;
  }

  /*if(this.dFromWork() <= 15.0){
    score++;
  }*/

// Rent price && dist from work
...
public static void generateMap(){
  ...
  HashMap<String, String> capitalCities = new HashMap<String, String>();
    ...
    public void box(double x, double y){ //Coordinate for center

      StdDraw.rectangle(x, y, 150, 100); //draw rectangle

      StdDraw.setPenColor(StdDraw.BLACK);
      StdDraw.textLeft(x-20, y+60, "Accessibility Score: " + this.score);
      StdDraw.textLeft(x-20, y+30, "Availability: " + this.isAvailable);
      StdDraw.textLeft(x-20, y, "Rent Price: " + this.rentPrice);
